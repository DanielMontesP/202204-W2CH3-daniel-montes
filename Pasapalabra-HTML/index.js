let questions = [
  ...
  },
  {
    ...
    answer: "atinar",
    status: 0,
    question: "CON LA A. Acertar, dar en el blanco",
  },
  {
    letter: "b",
    answer: "bingo",
  ...
  },
  {
    ...
    answer: "bota",
    status: 0,
    question: "CON LA B. Calzado que resguarda el pie y parte de la pierna",
  },
  {
    letter: "c",
    answer: "churumbel",
  ...
  },
  {
    ...
    answer: "cama",
    status: 0,
    question: "Con la C. Mueble donde las personas duermen o descansan",
  },
  {
    letter: "d",
    answer: "diarrea",
  ...
  },
  {
    ...
    answer: "disputa",
    status: 0,
    question: "Con la D. Enfrentamiento entre dos personas",
  },
  {
    letter: "e",
    answer: "ectoplasma",
  ...
  },
  {
    ...
    answer: "enero",
    status: 0,
    question: "Con la E. Primer mes del año",
  },
  {
    letter: "f",
    answer: "fácil",
  ...
  },
  {
    ...
    answer: "facil",
    status: 0,
    question: "Con la F. Contrario a difícil",
  },
  {
    letter: "g",
    answer: "galaxia",
  ...
  },
  {
    ...
    answer: "golpe",
    status: 0,
    question: "Con la G. Encuentro brusco y violento de un cuerpo contra otro",
  },
  {
    letter: "h",
    answer: "harakiri",
  ...
  },
  {
    ...
    answer: "iglesia",
    status: 0,
    question: "Con la I. Edificio destinado al culto cristiano",
  },
  {
    letter: "j",
    answer: "jabalí",
  ...
  },
  {
    ...
    answer: "jarrón",
    status: 0,
    question: "CON LA J. Jarra grande",
  },
  {
    letter: "k",
    answer: "kamikaze",
  ...
  },
  {
    ...
    answer: "kiosko",
    status: 0,
    question: "CON LA K. Donde se venden periodicos",
  },
  {
    letter: "l",
    answer: "licantropo",
  ...
  },
  {
    ...
    answer: "lima",
    status: 0,
    question: "CON LA L. Fruta con nombre de cuidad",
  },
  {
    letter: "m",
    answer: "misántropo",
    status: 0,
    question:
      "CO N LA M. Persona que huye del trato con otras personas o siente gran aversión hacia ellas",
  },
  {
    letter: "m",
    answer: "mesa",
    status: 0,
    question: "CON LA M. Mueble donde se come",
  },
  {
    letter: "n",
    answer: "necedad",
  ...
  },
  {
    ...
    answer: "nada",
    status: 0,
    question: "CON LA N. Contrario todo",
  },
  ...
  },
  {
    ...
    answer: "puerta",
    status: 0,
    question: "CON LA P. Separacion entre habitaciones",
  },
  {
    letter: "q",
    answer: "queso",
  ...
  },
  {
    ...
    answer: "quemar",
    status: 0,
    question: "CON LA Q. Abrasar o consumir algo con fuego",
  },
  { letter: "r", answer: "raton", status: 0, question: "CON LA R. Roedor" },
  {
    ...
    answer: "risa",
    status: 0,
    question: "CON LA R. Movimiento de la boca que demuestra alegría",
  },
  {
    letter: "s",
  ...
  },
  {
    ...
    answer: "señal",
    status: 0,
    question: "CON LA S. Indicio o señal de algo",
  },
  {
    letter: "t",
    answer: "terminator",
  ...
  },
  {
    ...
    answer: "uva",
    status: 0,
    question: "CON LA U. Fruto de la vid",
  },
  {
    letter: "v",
    answer: "vikingos",
  ...
  },
  {
    ...
    answer: "vaso",
    status: 0,
    question: "CON LA V. Recipiente que se utiliza para beber",
  },
  {
    letter: "w",
    answer: "waterpolo",
    status: 0,
    question:
      "CON LA W. Deporte parecido al fútbol, pero que se juega en la piscina",
  },
  {
    letter: "w",
    answer: "sandwich",
  ...
  },
  {
    ...
    status: 0,
    question:
      "CONTIENE LA X. Odio, hostilidad o antipatía hacia los extranjeros",
  },
  {
    letter: "y",
    answer: "peyote",
  ...
  },
  {
    ...
    answer: "yate",
    status: 0,
    question: "CONTIENE LA Y. Embarcación de recreo, generalmente lujosa",
  },
  {
    letter: "z",
    answer: "zen",
  ...
  },
  {
    ...
    answer: "zapato",
    status: 0,
    question: "CON LA Z. Calzado que cubre solamente el pie",
  },
];
...
let isFirstRun = true;
let ranking = [
  { usuario: "Player2", puntos: 2 },
  { usuario: "Player3", puntos: 4 },
  { usuario: "Player4", puntos: 5 },
];
let rosco = [];
let letraActual = "";
let letraAnterior = "";
...
function askForUserName(id) {
  ...
  document.getElementById("welcome-obs").innerHTML =
  ...
  describe("Given a askForUserNAme function", () => {
    describe("When it receives 'boquerones'", () => {
      test("Then it should return 'Boquerons'", () => {
        const text = "boquerons";
        const expectedText = "Boquerons";
        const textResult = "pepe";
...
function colorEngine(id) {
  ...
  for (let i = 0; i < listaLetras.length; i++) {
    ...
    setTimeout(function () {
      document.getElementById(nameId).style.background = id;
    }, 70 + z);
    z = z + 25;
  }
}
...
function resizeLetterContainer(size) {
  setTimeout(function () {
    document.getElementById(
      "letter" + letraActual.toUpperCase() + "-container"
    ).style.width = size;
    document.getElementById("letter" + letraActual.toUpperCase()).style.width =
      size;
    document.getElementById(
      "letter" + letraActual.toUpperCase() + "-container"
    ).style.height = size;
    document.getElementById("letter" + letraActual.toUpperCase()).style.height =
      size;
  }, 400);
}
...
function btJugar() {
  ...
  setTimeout(function () {
    colorEngine("rgba(23, 86, 247, 0.514)");
  }, 600);
  setTimeout(function () {
...
function sendInput(id) {
  ...
  document.getElementById("userScore-obs").innerHTML =
    "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
  ...
  if (document.getElementById("textTimer").innerHTML == "0") {
    ...
    setTimeout(function () {
      showMessageToUser(
        ...
        "&nbsp;&nbsp;&nbsp;&nbsp;¡" +
          userName.toUpperCase() +
          " el tiempo se ha acabado!<br><br><br><br>Aciertos: " +
          numAciertos +
          "<br>Errores: " +
          numErrores +
          "<br>Pasapalabras: " +
      ...
      document.getElementById("welcome-obs-container").style.textAlign =
        "center";
      ...
      document.getElementById("welcome-obs").innerHTML =
        "¡Se acabó el tiempo!<br><br><br><br><br><br><br><br>¿Jugamos de nuevo?";
      isNewGame = "1";
      timerSecondsToAdd = 0;
      numErrores = 0;
      setUserUI("hidden");
...
function lightLetter() {
  if (questionIsAnswered) {
    ...
    setTimeout(function () {
      if (parseInt(document.getElementById("textTimer").innerHTML) <= 10) {
        ...
        document.getElementsByClassName("timer-content")[0].style.background =
          "rgb(247, 31, 12)";
        document.getElementById(
          "letter" + letraActual.toUpperCase()
        ).style.height = "57px";
      }
      document.getElementById(
        "letter" + letraActual.toUpperCase()
      ).style.background = "rgb(0 133 243)";
      document.getElementById(
        "letter" + letraActual.toUpperCase()
      ).style.fontSize = "40px";
      document.getElementById(
      ...
      letterLastPos = document.getElementById(
        "letter" + letraActual.toUpperCase() + "-container"
      ).style.top;
      document.getElementById(
        "letter" + letraActual.toUpperCase() + "-container"
      ).style.top = letterLastPos - 2;
      document.getElementById(
        "letter" + letraActual.toUpperCase() + "-container"
      ).style.width = "57px";
      document.getElementById(
    ...
    if (letraActual != "" && !isGameOver) {
      setTimeout(function () {
        ...
        document.getElementById(
          "letter" + letraActual.toUpperCase()
        ).style.background = "rgba(23, 86, 247, 0.514)";
        document.getElementById(
          "letter" + letraActual.toUpperCase()
        ).style.width = "55px";
        document.getElementById(
  ...
  if (isGameOver) {
    ...
    setTimeout(function () {
      colorEngine(
        "linear-gradient(90deg, rgb(0 69 168) 0%, rgb(0 98 210) 42%, rgb(0 83 183) 100%)"
      );
    }, 600);
    ...
    setTimeout(function () {
      showMessageToUser(
        ...
        "¡Enhorabuena!<br><br>Aciertos: " +
          ...
          "<br>Pasapalabras: " +
          numPasapalabras +
          "<br><br><br><br>¿Quiere jugar otra vez?"
      );
      document.getElementById("userScore-obs").innerHTML =
        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
        userName.toUpperCase() +
      ...
      document.getElementById("userScore").style.visibility = "visible";
      document.getElementById("welcome-obs").innerHTML =
        "¡Enhorabuena!<br><br><br><br><br><br><br>¿Jugamos de nuevo?";
...
function hacerPregunta() {
  ...
  if (quedanPreguntas()) {
    ...
    document.getElementById(
      "letter" + letraActual.toUpperCase()
    ).style.background = "rgb(23, 87, 247)";
    document.getElementById("pasapalabra-container").style.visibility =
      "visible";
    document.getElementById("return").style.visibility = "visible";
    document.getElementById("pasapalabra").style.visibility = "visible";
...
function setLetterCorrectSize() {
  document.getElementById(
    "letter" + letraActual.toUpperCase() + "-container"
  ).style.top = letterLastPos;
  document.getElementById("letter" + letraActual.toUpperCase()).style.fontSize =
    "35px";
  document.getElementById(
    "letter" + letraActual.toUpperCase()
  ).style.background = "rgba(23, 86, 247, 0.514)";
  ...
  switch (userAnswer) {
    ...
    default:
      ...
      if (userAnswer == verifiedAnswer) {
        ...
        document.getElementById(
          "letter" + letraActual.toUpperCase()
        ).style.background = "rgb(26, 197, 63)";
        ...
        document.getElementById(
          "letter" + letraActual.toUpperCase()
        ).style.background = "rgb(226, 24, 24)";
        numErrores += 1;
...
function reiniciarRosco() {
  ...
  for (let i = 0; i < rosco.length; i++) {
    if (rosco[i].asked == false) {
      roscoTemp.push({
        letter: rosco[i].letter,
        answer: rosco[i].answer,
        question: rosco[i].question,
        asked: false,
      });
    }
  }
...
function mostrarPuntuacion(tabla) {
  document.getElementById("userScore").style.visibility = "visible";
  document.getElementById("ranking").style.visibility = "visible";
  document.getElementById("ranking-obs").innerHTML =
    "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RANKING" + "<br>";
  let i = 1;
  ...
  for (let i = 0; i < listaLetras.length; i++) {
    for (let y = 0; y < questions.length; y++) {
      if (listaLetras[i] == questions[y].letter && questions[y].status == 0) {
        ...
        rosco.push({
          letter: questions[y].letter,
          answer: questions[y].answer,
          question: questions[y].question,
          asked: false,
        });
        i += numPregPorLetra - 1;
      }
